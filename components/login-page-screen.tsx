    ...
    return (
      <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col justify-center px-4 py-10 md:py-14 lg:py-16">
        ...
        >
          ...
          >
            <div
              className="pointer-events-none absolute inset-0 bg-[image:var(--awp-bg-stadium)] bg-cover bg-center opacity-40"
              aria-hidden
            />
            <div
            ...
            <div className="relative z-10 flex w-full max-w-xs flex-col items-center">
              ...
              <p className="text-xs font-bold uppercase tracking-[0.28em] text-emerald-300">Konto gracza</p>
              <h1 className="mt-2 font-sans text-3xl font-black leading-tight tracking-tight text-white md:text-4xl">
                {siteName}
              </h1>
          ...
          <section className="flex flex-col justify-center px-6 py-10 sm:px-10 md:px-12 md:py-14" aria-label="Formularz logowania">
            <div className="mx-auto w-full max-w-md">
              ...
              <div className="mt-8 space-y-2 border-t border-zinc-100 pt-6 text-center text-sm dark:border-zinc-800">
                <Link href={registerHref} className="block font-semibold text-emerald-700 hover:underline dark:text-emerald-300">
