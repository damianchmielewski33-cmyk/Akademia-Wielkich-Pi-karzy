...
export function TerminarzClient({
  ...
  /** Tła paneli: tylko domyślne Unsplash — custom admina wyłącznie w MarketplacePhotoStrip. */
    ...
    return (
      <div className={actionBarClass}>
        ...
        <div className="flex flex-col gap-2 border-t border-zinc-200/80 pt-2.5 dark:border-zinc-600/80 sm:flex-row sm:flex-wrap">
            ...
            <Button
              ...
              title={
                captainLotteryData[m.id] != null && !captainLotteryData[m.id].locked
                  ...
                  : "Dodaje rundę losowania — także gdy nikt jeszcze nie potwierdził «wpadam»"
              }
          ...
          {(captainLotteryHistory[m.id]?.length > 0 || captainLotteryData[m.id] != null) && (
            <Button
              size="sm"
              variant="ghost"
              className={actionBtnDanger}
              disabled={clearLotteryBusyId === m.id}
