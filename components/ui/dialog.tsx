  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "awp-modal-content [&>button]:absolute [&>button]:right-3 [&>button]:top-3",
        // Style X na granatowym nagłówku formularza — tylko gdy AppModal doda --form
        "[&.awp-modal-content--form>button]:top-4 [&.awp-modal-content--form>button]:border-white/20 [&.awp-modal-content--form>button]:bg-white/10 [&.awp-modal-content--form>button]:text-white [&.awp-modal-content--form>button]:shadow-none [&.awp-modal-content--form>button]:hover:border-white/35 [&.awp-modal-content--form>button]:hover:bg-white/15 [&.awp-modal-content--form>button]:hover:text-white",
        className
      )}
      {...props}
    >
