...
export function StartWorkoutFab() {
  ...
  return (
    <Link
      href="/start-workout"
      className={cn(
        "awp-focus-ring fixed z-[56] inline-flex items-center gap-2 rounded-2xl border border-teal-200/80",
        "bg-[var(--mp-teal)] px-4 py-3 text-xs font-semibold text-white shadow-lg shadow-teal-950/20 transition hover:bg-[var(--mp-teal-dark)]",
        "left-3 sm:left-4",
        hasActiveSession
    ...
    >
      ...
      <span className="min-w-0 pr-0.5">
        <span className="block text-[10px] font-medium uppercase tracking-[0.16em] text-white/80">
          Trening
        </span>
